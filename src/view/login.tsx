...
let elementById: HTMLElement = document.getElementById(
  "password"
) as HTMLElement;
...
function Login() {
  ...
  const loginAction = () => {
    ...
    axios
      .post("http://localhost:8080/Billing_System_war_exploded/user", data, {
        headers: headers,
      })
      .then((res) => {
  ...
  return (
    <>
      ...
      >
        <div
          className={
            "w-[70%] h-[80%] bg-amber-0 rounded-xl flex flex-row items-center justify-center drop-shadow-2xl"
          }
        >
          {/* <div
          ...
          <div
            id={"login-form"}
            className={
              "w-[30%] h-full bg-white rounded-r-xl flex flex-col justify-center items-center p-[20px]"
            }
          >
            <div
            ...
            >
              <div
                className={
                  "bg-[url(assets/images/logo/logo-2.png)] w-[130px] h-[80px] bg-cover bg-center"
                }
              ></div>
              ...
              <h1
                className={"font-Zet text-2xl font-bold text-fuchsia-900 mt-2"}
              >
                Welcome Back
              </h1>
            </div>

            <p className={"font-Poppins font-medium text-[13px] mt-2"}>
            ...
            <div className={"mt-5 w-full px-2 mb-auto"}>
              <button
                className={
                  "w-full h-[40px] bg-gradient-to-r from-indigo-500 to-sky-500 text-white hover:bg-gradient-to-l from-[#3264F5] to-[#3297F5] rounded flex flex-row justify-center items-center"
                }
                onClick={loginAction}
              >
                Log in{" "}
